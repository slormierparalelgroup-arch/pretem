...
const dictionaries: Record<Language, Dictionary> = {
  ht: {
    ...
    agreementRequired: "Ou dwe aksepte tèm prè yo ak avi rapò kredi a anvan ou voye demann lan.",
    approve: "Apwouve",
    ...
    publicStoryConsentHelp: "PRETEM pap pibliye pyès idantite, selfie ak ID, oswa dokiman prive verifikasyon sou rezo sosyal.",
  ...
  en: {
    ...
    agreementRequired: "You must accept the loan terms and credit reporting notice before submitting.",
    approve: "Approve",
    ...
    publicStoryConsentHelp: "PRETEM will not publish ID documents, selfie with ID, or private verification documents on social media.",
  ...
  es: {
    ...
    agreementRequired: "Debes aceptar los términos del préstamo y el aviso de reporte de crédito antes de enviar.",
    approve: "Aprobar",
    ...
    publicStoryConsentHelp: "PRETEM no publicará documentos de identificación, selfie con identificación ni documentos privados de verificación en redes sociales.",
