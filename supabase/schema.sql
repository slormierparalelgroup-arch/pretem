...
create or replace function public.normalize_existing_loans()
returns void
language plpgsql
security definer
set search_path = public
...
revoke all on function public.normalize_existing_loans() from public;

select public.normalize_existing_loans();
