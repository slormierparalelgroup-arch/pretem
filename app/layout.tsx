        ...
        <style
          dangerouslySetInnerHTML={{
            __html: `
              ...
              .brand{align-items:center;color:#0b3d75;display:inline-flex;font-size:24px;font-weight:800}.brand img{display:block;height:46px;object-fit:contain;width:auto}
